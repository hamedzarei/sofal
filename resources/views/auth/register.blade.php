...
<form class="form-horizontal" method="POST" action="{{ route('register') }}">
    ...
    <p class="{{ $errors->has('name') ? ' has-error' : '' }}">
        <label for="name" class="control-label floatLabel">نام</label>
    ...
    <p class="">
        <label for="password-confirm" class="control-label floatLabel  ">تایید رمز عبور</label>
        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
    </p>

    <p>
        <input type="submit" value="ثبت اکانت کاربری" id="submit">
    </p>
